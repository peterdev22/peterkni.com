...
<svelte:head>
  <meta
    name="description"
    content="Peter Knight's portfolio of computer aided design (CAD), VEX robotics competition and programming projects."
  />
...
>
  <div class="mb-6 px-10 lg:px-28 xl:px-52 2xl:px-80 flex gap-12 items-center">
    ...
    <p class="font-medium text-xl text-white">
      The 3D printer made for home users.
    </p>
  </div>
...
>
  ...
  <div class="flex gap-10 justify-center h-96">
