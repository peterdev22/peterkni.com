...
<header class="p-5 sm:p-10 px-10 xl:px-20 2xl:px-48 py-4 flex justify-center">
  <div
    class="flex gap-16 items-center justify-between w-[90rem] sm:px-10  py-5 rounded-[2rem] sm:outline outline-1 outline-zinc-950 bg-opacity-80 sm:bg-gradient-to-tr from-black to-zinc-950"
  >
    <a
      href="/"
    ...
    >
      <svg
        ...
        /></svg
      >
      <h1 class="text-2xl sm:text-4xl md:text-4xl transition-all">Peter Knight</h1>
    </a>
    ...
    <button class="lg:hidden bg-white w-6">
      yes!
    </button>
  </div>
</header>
