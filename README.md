...
The framework used is [Svelte](https://svelte.dev/)/[SvelteKit](https://kit.svelte.dev/) and it's been very fun to use so far. It's also using [Tailwind](https://tailwindcss.com/) to manage css styles.
