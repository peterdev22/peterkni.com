...
<div class="flex flex-col md:flex-row">
  ...
  <div class="basis-8/12 mx-7 xl:basis-4/12">
    <h1
      ...
      bind:this={title}
      class="text-subtext-1 font-body text-3xl font-bold my-6 md:mt-40 animate-zoomFadeIn"
    >
      ~/peters-website
    </h1>
    ...
    <a
      ...
      class="transition-all duration-500 ease-in-out text-overlay-1 font-body text-lg font-bold animate-zoomFadeIn hover:text-yellow hover:ml-1.5"
    >
      <svg
  ...
  <div class="basis-2/12 xl:basis-6/12" />
</div>
